...
<#
    ...
    Setzt das Download Verhalten auf "FILEDEPOT_ONLY" (AusschlieÃŸlich Ã¼ber FileDepot downloaden), "FILEDEPOT_AND_DIRECT" (HauptsÃ¤chlich Ã¼ber das FileDepott downloaden, ansonsten Ã¼ber direktem Weg), "DIRECT_ONLY" (Ausschließlich über direktem Weg downloaden ohne FileDepot)
    ...
    Kategorien die abgewählt werden sollen.

    .EXAMPLE 
    .\ChangeSUSettings.ps1 -AuthToken "ApiKey" -CustomerId "ID des Kunden" -UpdateDelay "Tage für die Verzögerung" -installDelay "Tage fÃ¼r die Installation"
    
    .EXAMPLE
    .\ChangeSUSettings.ps1 -AuthToken "ApiKey" -CustomerId "ID des Kunden" -UpdateDelay "Tage für die Verzögerung" -installDelay "Tage fÃ¼r die Installation" -AddCategories MICROSOFT -RemoveCategories EDGE
    
    .EXAMPLE
    .\ChangeSUSettings.ps1 -AuthToken "ApiKey" -CustomerId "ID des Kunden" -UpdateDelay "Tage für die Verzögerung" -installDelay "Tage fÃ¼r die Installation" -ViewfilterName "Name einer Gruppe"
