...
<#
    ...
    .EXAMPLE
    PS> .\Relocate-Sensorhub.ps1 -customerID 42569786 -parentGuid 4f1kg420-2315-28he-89bc-509s20b25f76 -secretKey e12ejgcf-d491-9892-bg83-95ka457938c2 -cleanup true
...
#Logfile path
$Logpath = "$env:windir\Temp\Relocate-Sensorhub.log"
#endregion
...
SEStop-Services
if ($OCCConnector) { SEConvertTo-Sensorhub }
SEEdit-Configfile
SEClean-Datapath
SEStart-Services
#endregion